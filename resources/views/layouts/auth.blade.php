...
@section("content")
	<main class="flex justify-center">
		<div class="min-h-screen w-[320px] sm:w-[500px] flex flex-col justify-between">
			@yield("main")
			...
			<div class="py-4">
				...
				<div>
					<ul class="w-full inline-flex justify-around">
						...
						<li class="inline">
							<x-link href="#" class="text-sm text-gray-500 hover:text-gray-700 dark:hover:text-info-600">{{ __('Nous contacter') }}</x-link>
						</li>
