			...
			<x-form method="POST" action="{{ route('complete.store') }}">
				<div class="mb-2 sm:mb-4">
					...
					<div class="grid grid-cols-1 sm:grid-cols-2 gap-y-3 sm:gap-y-0 sm:gap-x-4">
						<x-radio-card name="type" showOrHide="enterprise" showOrHideAction="hide" tabindex="0">
						...
						<x-radio-card name="type" showOrHide="enterprise" showOrHideAction="show" tabindex="1">
							<div class="flex gap-x-2">
								<div>
