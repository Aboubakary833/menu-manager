    ...
    <div class="w-[300px] sm:w-[400px] md:w-[450px]">
        <x-card class="shadow-none border-none">
                ...
                <div class="flex justify-center">
                    <svg height="150px" width="150px" id="Layer_1" xmlns="http://www.w3.org/2000/svg"
                        ...
                        <g id="SVGRepo_iconCarrier">
                            <path style="fill:#febc59;"
                                  d="M294.625,4.4c-9.3,0-17.9,3.4-24.7,10.2l-256,256c-6.8,6.8-10.2,16.2-10.2,24.7h0.8 c0,11.1,8.6,23,8.6,22.2l172.3,172.4c6,6.8,15.4,10.2,23.9,10.2V500c9-0.2,17.3-3.6,23.9-10.2l256-256c6.8-6.8,10.2-16.2,10.2-24.7 s-3.4-17.1-10.2-23.9l-171.5-171.5c0,0-14.5-8.5-23-8.5"></path>
                            <path
            ...
            <x-card.body class="text-slate-600 dark:text-info-100 text-[15px]">
                <p>
                    {{ __("pages.auth.register.verify.description", ["email" => "johndoe@gmail.com"]) }}
                </p>
                <div class="my-4">
                    <p class="mt-2">
